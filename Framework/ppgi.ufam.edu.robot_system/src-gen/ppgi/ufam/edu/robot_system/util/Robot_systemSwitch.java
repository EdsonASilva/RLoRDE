 ...
 * @generated
 */
public class Robot_systemSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Robot_systemPackage.ROBOT_SYSTEM: {
			Robot_System robot_System = (Robot_System) theEObject;
			T result = caseRobot_System(robot_System);
			if (result == null)
		...
		case Robot_systemPackage.WORLD_SYSTEM: {
			World_System world_System = (World_System) theEObject;
			T result = caseWorld_System(world_System);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Robot_systemPackage.DISCRETIZE: {
			Discretize discretize = (Discretize) theEObject;
			T result = caseDiscretize(discretize);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Robot System</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Robot System</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRobot_System(Robot_System object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>World System</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>World System</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWorld_System(World_System object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Discretize</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Discretize</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDiscretize(Discretize object) {
		return null;
	}
