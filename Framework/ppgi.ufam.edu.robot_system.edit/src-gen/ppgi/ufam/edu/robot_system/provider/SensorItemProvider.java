...
/**
 * This is the item provider adapter for a {@link ppgi.ufam.edu.robot_system.Sensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SensorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDiscretizePropertyDescriptor(object);
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Sensor_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Sensor_type_feature", "_UI_Sensor_type"),
						Robot_systemPackage.Literals.SENSOR__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Discretize feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDiscretizePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Sensor_discretize_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Sensor_discretize_feature",
								"_UI_Sensor_type"),
						Robot_systemPackage.Literals.SENSOR__DISCRETIZE, true, false, true, null, null, null));
	}
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Sensor_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Sensor_id_feature", "_UI_Sensor_type"),
						Robot_systemPackage.Literals.SENSOR__ID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
